...
public final class Constants {
    ...
    public static double climberRibbon = -60; // -245;
    ...
    // Base Constants
    public static int talonOneCANID = 5;
    public static int talonTwoCANID = 4;
    public static int talonThreeCANID = 6;
    public static int talonFourCANID = 7;
}